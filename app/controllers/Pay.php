...
use Inpush\PaymentGateways\Coinbase;
...
class Pay extends Controller {
    ...
    public function index() {
        ...
        switch($this->plan_id) {
            ...
            default:
                ...
                $this->plan_taxes = (new \Inpush\Models\Plan())->get_plan_taxes_by_taxes_ids($this->plan->taxes_ids);
        ...
        $view = new \Inpush\Views\View('pay/index', (array) $this);
    ...
    private function paypal() {
        ...
        try {
            $paypal_api_url = \Inpush\PaymentGateways\Paypal::get_api_url();
            $headers = \Inpush\PaymentGateways\Paypal::get_headers();
        } catch (\Exception $exception) {
...
//                    'start_time' => (new \DateTime())->modify('+30 seconds')->format(DATE_ISO8601),
    ...
    private function offline_payment() {
        ...
        if(!\Inpush\Plugin::is_active('offload') || (\Inpush\Plugin::is_active('offload') && !settings()->offload->uploads_url)) {
        ...
        /* Offload uploading */
        if(\Inpush\Plugin::is_active('offload') && settings()->offload->uploads_url) {
            try {
    ...
    private function redirect_pay_thank_you() {
        ...
        $thank_you_url_parameters .= '&unique_transaction_identifier=' . md5(\Inpush\Date::get('', 4) . $thank_you_url_parameters);
