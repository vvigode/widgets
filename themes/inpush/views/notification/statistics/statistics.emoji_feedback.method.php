        ...
        <?php while($row = $result->fetch_object()): ?>
            <tr>
                <td class="text-nowrap">
                    <img src="<?= ASSETS_FULL_URL . 'images/emojis/' . str_replace('feedback_emoji_', '', $row->type) . '.svg' ?>" class="inpush-emoji-feedback-emoji" data-type="angry" /> <?= language()->notification->emoji_feedback->{$row->type} ?>
                </td>
