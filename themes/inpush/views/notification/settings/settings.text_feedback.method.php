...
<?php ob_start() ?>
    <script>
        ...
        $('#inpush-text-feedback-form').on('submit', event => event.preventDefault());

        $('#notification_preview .inpush-text-feedback-hidden').removeClass('inpush-text-feedback-hidden').addClass('inpush-text-feedback-shown');

        /* Notification Preview Handlers */
        $('#settings_title').on('change paste keyup', event => {
            $('#notification_preview .inpush-text-feedback-title').text($(event.currentTarget).val());
        });

        $('#settings_description').on('change paste keyup', event => {
            $('#notification_preview .inpush-text-feedback-description').text($(event.currentTarget).val());
        });
        ...
        settings_title_color_pickr.on('change', hsva => {
            ...
            $('#notification_preview .inpush-text-feedback-title').css('color', hsva.toHEXA().toString());
        });
        ...
        settings_description_color_pickr.on('change', hsva => {
            ...
            /* Notification Preview Handler */
            $('#notification_preview .inpush-text-feedback-description').css('color', hsva.toHEXA().toString());
        });
