...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .inpush-emoji-feedback-title').text($(event.currentTarget).val());
    });

    $('#settings_description').on('change paste keyup', event => {
        $('#notification_preview .inpush-emoji-feedback-description').text($(event.currentTarget).val());
    });
    ...
    $('[id*="share_"]').on('change', event => {
        ...
        if($(event.currentTarget).is(':checked')) {
            $(`#notification_preview .inpush-emoji-feedback-button-${share_type}`).show();
        } else {
            $(`#notification_preview .inpush-emoji-feedback-button-${share_type}`).hide();
        }
    });
    ...
    settings_title_color_pickr.on('change', hsva => {
        ...
        $('#notification_preview .inpush-emoji-feedback-title').css('color', hsva.toHEXA().toString());
    });
