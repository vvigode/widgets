...
<?php ob_start() ?>
    <script>
        ...
        $('#inpush-request-collector-form').on('submit', event => event.preventDefault());

        /* Notification Preview Handlers */
        $('#settings_title').on('change paste keyup', event => {
            $('#notification_preview .inpush-request-collector-title').text($(event.currentTarget).val());
        });

        $('#settings_description').on('change paste keyup', event => {
            $('#notification_preview .inpush-request-collector-description').text($(event.currentTarget).val());
        });

        $('#settings_image').on('change paste keyup', event => {
            $('#notification_preview .inpush-request-collector-image').attr('src', $(event.currentTarget).val());
        });

        $('#settings_content_title').on('change paste keyup', event => {
            $('#notification_preview .inpush-request-collector-content-title').text($(event.currentTarget).val());
        });

        $('#settings_content_description').on('change paste keyup', event => {
            $('#notification_preview .inpush-request-collector-content-description').text($(event.currentTarget).val());
        });
        ...
        settings_title_color_pickr.on('change', hsva => {
            ...
            $('#notification_preview .inpush-request-collector-title').css('color', hsva.toHEXA().toString());
        });
        ...
        settings_description_color_pickr.on('change', hsva => {
            ...
            /* Notification Preview Handler */
            $('#notification_preview .inpush-request-collector-description').css('color', hsva.toHEXA().toString());
        });
        ...
        settings_content_title_color_pickr.on('change', hsva => {
            ...
            /* Notification Preview Handler */
            $('#notification_preview .inpush-request-collector-content-title').css('color', hsva.toHEXA().toString());
        });
        ...
        settings_content_description_color_pickr.on('change', hsva => {
            ...
            /* Notification Preview Handler */
            $('#notification_preview .inpush-request-collector-content-description').css('color', hsva.toHEXA().toString());
        });
