...
<?php ob_start() ?>
    <script>
        ...
        $('#inpush-email-collector-form').on('submit', event => event.preventDefault());

        /* Notification Preview Handlers */
        $('#settings_title').on('change paste keyup', event => {
            $('#notification_preview .inpush-email-collector-title').text($(event.currentTarget).val());
        });

        $('#settings_description').on('change paste keyup', event => {
            $('#notification_preview .inpush-email-collector-description').text($(event.currentTarget).val());
        });
        ...
        settings_title_color_pickr.on('change', hsva => {
            ...
            $('#notification_preview .inpush-email-collector-title').css('color', hsva.toHEXA().toString());
        });
        ...
        settings_description_color_pickr.on('change', hsva => {
            ...
            /* Notification Preview Handler */
            $('#notification_preview .inpush-email-collector-description').css('color', hsva.toHEXA().toString());
        });
