...
<script>
    ...
    $('#settings_description').on('change paste keyup', event => {
        $('#notification_preview .inpush-cookie-notification-description').text($(event.currentTarget).val());
    });

    $('#settings_image').on('change paste keyup', event => {
        $('#notification_preview .inpush-cookie-notification-image').attr('src', $(event.currentTarget).val());
    });

    $('#settings_url_text').on('change paste keyup', event => {
        $('#notification_preview .inpush-cookie-notification-url').text($(event.currentTarget).val());
    });

    $('#settings_button_text').on('change paste keyup', event => {
        $('#notification_preview .inpush-cookie-notification-button').text($(event.currentTarget).val());
    });
    ...
    settings_description_color_pickr.on('change', hsva => {
        ...
        $('#notification_preview .inpush-cookie-notification-description').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_button_background_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-cookie-notification-button').css('background', hsva.toHEXA().toString());
    });
    ...
    settings_button_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-cookie-notification-button').css('color', hsva.toHEXA().toString());
    });
</script>
