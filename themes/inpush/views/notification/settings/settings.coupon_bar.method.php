...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .inpush-coupon-bar-title').text($(event.currentTarget).val());
    });

    $('#settings_coupon_code').on('change paste keyup', event => {
        $('#notification_preview .inpush-coupon-bar-coupon-code').text($(event.currentTarget).val());
    });
    ...
    settings_title_color_pickr.on('change', hsva => {
        ...
        $('#notification_preview .inpush-coupon-bar-title').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_coupon_code_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-coupon-bar-coupon-code').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_coupon_code_background_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-coupon-bar-coupon-code').css('background', hsva.toHEXA().toString());
    });
    ...
    settings_coupon_code_border_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-coupon-bar-coupon-code').css('border-color', hsva.toHEXA().toString());
    });
</script>
