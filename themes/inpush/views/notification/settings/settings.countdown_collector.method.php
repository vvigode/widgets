...
<?php ob_start() ?>
    ...
    <div class="form-group">
        ...
        <input type="text" id="settings_end_date" name="end_date" class="form-control" value="<?= \Inpush\Date::get($data->notification->settings->end_date, 1) ?>" autocomplete="off" required="required" />
    </div>
...
<script>
    ...
    $('#inpush-countdown-collector-form').on('submit', event => event.preventDefault());

    /* Notification Preview Handlers */
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .inpush-countdown-collector-title').text($(event.currentTarget).val());
    });

    $('#settings_description').on('change paste keyup', event => {
        $('#notification_preview .inpush-countdown-collector-description').text($(event.currentTarget).val());
    });

    $('#settings_content_title').on('change paste keyup', event => {
        $('#notification_preview .inpush-countdown-collector-content-title').text($(event.currentTarget).val());
    });
    ...
    settings_title_color_pickr.on('change', hsva => {
        ...
        $('#notification_preview .inpush-countdown-collector-title').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_description_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-countdown-collector-description').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_content_title_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-countdown-collector-content-title').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_time_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-countdown-collector-time').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_time_background_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-countdown-collector-time').css('background', hsva.toHEXA().toString());
    });
