...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .inpush-image-title').text($(event.currentTarget).val());
    });

    $('#settings_image').on('change paste keyup', event => {
        $('#notification_preview .inpush-image-image-img').attr('src', $(event.currentTarget).val());
    });
    ...
    $('#settings_button_text').on('change paste keyup', event => {
        ...
        if(text.trim() == '') {
            $('#notification_preview .inpush-image-button').hide();
        } else {
            $('#notification_preview .inpush-image-button').show().text(text);
        }
    });
    ...
    settings_title_color_pickr.on('change', hsva => {
        ...
        $('#notification_preview .inpush-image-title').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_button_background_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-image-button').css('background', hsva.toHEXA().toString());
    });
    ...
    settings_button_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .inpush-image-button').css('color', hsva.toHEXA().toString());
    });
</script>
