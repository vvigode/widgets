        ...
        <div class="row mb-5">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control <?= \Inpush\Alerts::has_field_errors('name') ? 'is-invalid' : null ?>" value="<?= $this->user->name ?>" maxlength="32" />
                    <?= \Inpush\Alerts::output_field_error('name') ?>
                </div>

                <div class="form-group">
                    <label for="email"><?= language()->account->settings->email ?></label>
                    <input type="text" id="email" name="email" class="form-control <?= \Inpush\Alerts::has_field_errors('email') ? 'is-invalid' : null ?>" value="<?= $this->user->email ?>" maxlength="128" />
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <select id="twofa_is_enabled" name="twofa_is_enabled" class="form-control <?= \Inpush\Alerts::has_field_errors('twofa_token') ? 'is-invalid' : null ?>">
                ...
                <div id="twofa_container">
                    <?php if(!$this->user->twofa_secret): ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="twofa_token" name="twofa_token" class="form-control <?= \Inpush\Alerts::has_field_errors('twofa_token') ? 'is-invalid' : null ?>" value="" autocomplete="off" />
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="password" id="old_password" name="old_password" class="form-control <?= \Inpush\Alerts::has_field_errors('old_password') ? 'is-invalid' : null ?>" />
                    <?= \Inpush\Alerts::output_field_error('old_password') ?>
                </div>

                <div class="form-group">
                    <label for="new_password"><?= language()->account->change_password->new_password ?></label>
                    <input type="password" id="new_password" name="new_password" class="form-control <?= \Inpush\Alerts::has_field_errors('new_password') ? 'is-invalid' : null ?>" />
                    <?= \Inpush\Alerts::output_field_error('new_password') ?>
                </div>

                <div class="form-group">
                    <label for="repeat_password"><?= language()->account->change_password->repeat_password ?></label>
                    <input type="password" id="repeat_password" name="repeat_password" class="form-control <?= \Inpush\Alerts::has_field_errors('repeat_password') ? 'is-invalid' : null ?>" />
                    <?= \Inpush\Alerts::output_field_error('repeat_password') ?>
                </div>
            </div>
        </div>
